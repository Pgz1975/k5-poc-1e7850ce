...
export default function StudentExercisesProgressV2() {
  ...
  // V2 Color schemes for units - matching lessons
        ...
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="mb-12 text-center">
            ...
            >
              ...
              <span className="font-bold text-gray-700">
                {t("Tu Progreso de Práctica", "Your Practice Progress")}
              </span>
            </motion.div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">
              {t("Ejercicios", "Exercises")}
            </h1>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="w-full h-4 bg-gray-200 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-[hsl(176,84%,55%)] to-[hsl(125,100%,55%)] rounded-full transition-all duration-500"
          ...
          <div className="space-y-20">
            {exerciseGroups.map((group, groupIndex) => {
              const domainCompletedCount = group.exercises.filter((exercise: any) => 
              ...
              return (
                ...
                >
                  ...
                  <UnitHeader
                    ...
                    totalLessons={group.exercises.length}
